...
import { fromBN, toBN } from '../../scripts/common/web3utils';
...
export function assertCloseToPercentage(a: BigNumber, b: BigNumber, percentage: BigNumber = toBN('0.005')) {
...
export function assertNotCloseToPercentage(a: BigNumber, b: BigNumber, percentage: BigNumber = toBN('0.005')) {
  if (b.eq(0)) {
